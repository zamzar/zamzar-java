...
public class Jobs {
  ...
  public Jobs paging(@javax.annotation.Nullable PagingNumeric paging) {
    this.paging = paging;
    return this;
  }
  ...
  public Jobs data(@javax.annotation.Nullable List<Job> data) {
    this.data = data;
    return this;
  }

  public Jobs addDataItem(Job dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    Jobs jobs = (Jobs) o;
    return Objects.equals(this.paging, jobs.paging) &&
        Objects.equals(this.data, jobs.data);
  }
