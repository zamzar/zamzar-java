...
public class FormatTargetsInner {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "credit_cost"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormatTargetsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FormatTargetsInner is not found in the empty JSON string", FormatTargetsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormatTargetsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FormatTargetsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
