...
public class PagingNumeric {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_count", "first", "last", "limit"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagingNumeric.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PagingNumeric is not found in the empty JSON string", PagingNumeric.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PagingNumeric.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PagingNumeric` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
