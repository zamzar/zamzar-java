...
public class Imports {
  ...
  public Imports paging(@javax.annotation.Nullable PagingNumeric paging) {
    this.paging = paging;
    return this;
  }
  ...
  public Imports data(@javax.annotation.Nullable List<ModelImport> data) {
    this.data = data;
    return this;
  }

  public Imports addDataItem(ModelImport dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<ModelImport> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paging, imports.paging) &&
        Objects.equals(this.data, imports.data);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("paging", "data"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Imports.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Imports is not found in the empty JSON string", Imports.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Imports.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Imports` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ModelImport.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Imports.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Imports' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Imports> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Imports.class));

       return (TypeAdapter<T>) new TypeAdapter<Imports>() {
           @Override
           public void write(JsonWriter out, Imports value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Imports read(JsonReader in) throws IOException {
